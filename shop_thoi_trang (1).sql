...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2025 at 04:50 PM
...
(14, 'VÕ ĐOÀN TRỌNG PHÚ', '281220', 'PHÚ', '6543@gmail.com', 0, '', 'khach_hang', '2025-11-04 08:44:07'),
...
('SP0025', 'kim', 12, 12, 'ksaodcoj', 'uploads/quanThun1.jpg', 1, 'ICONDENIM', 1, 'Còn hàng', '2025-11-08 12:24:06', '2025-11-08 12:24:41', 'SEP05'),
...
--
-- Indexes for table `giao_dich_thanh_toan`
--
...
--
ALTER TABLE `binh_luan`
  MODIFY `id_BL` int(11) NOT NULL AUTO_INCREMENT COMMENT 'khóa chính, id bình luận', AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `danh_muc`
--
ALTER TABLE `danh_muc`
  MODIFY `id_DM` int(11) NOT NULL AUTO_INCREMENT COMMENT 'khóa chính, id danh mục', AUTO_INCREMENT=15;
...
--
ALTER TABLE `nguoi_dung`
  MODIFY `id_ND` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'khóa chính, id người dùng', AUTO_INCREMENT=16;
...
--
-- Constraints for table `giao_dich_thanh_toan`
--
ALTER TABLE `giao_dich_thanh_toan`
