...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $db->query('INSERT INTO Users (full_name, email, password, role_id, employee_status, created_at) VALUES (:full_name, :email, :password, :role_id, :status, NOW())');
            ...
            <form method="post">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Nhập họ tên" value="<?php echo htmlspecialchars($full_name); ?>" required>
                    </div>
                    <div class="form-group">
